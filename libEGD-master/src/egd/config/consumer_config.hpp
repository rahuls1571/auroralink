 ...
 */
#ifndef _LIBEGD_EGD_CONFIG_CONSUMER_CONFIG_HPP_
#define _LIBEGD_EGD_CONFIG_CONSUMER_CONFIG_HPP_
 ...
 */
class ConsumerConfig : public EgdConfig {
 public:
  /**
   ...
   */
  ConsumerConfig(const std::string& host, uint16_t port);
...
#endif  // _LIBEGD_EGD_CONFIG_CONSUMER_CONFIG_HPP_
